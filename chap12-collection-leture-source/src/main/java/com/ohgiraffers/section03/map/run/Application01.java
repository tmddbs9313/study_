...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*수업목표. Map의 자료구조에 대해 이해하고 HashMap 을 이용할 수 있다.*/
        /*필기. Map 인터페이스의 특징
        ...
        *
        * 필기. HashMap, HashTable, TreeMap 등이 대표적인 클래스이다.
        *  HashMap 가장 많이 쓰인다.*/
...
//        List list = new ArrayList<>();
        ...
        System.out.println("hmap = " + hmap);  //key 와 value 로 나타냄. 순서는 랜덤
        ...
        System.out.println("hmap = " + hmap);  //key 값이 달라도 상관 ㄴ
