...
public class Application03 {
    public static void main(String[] args) {
        ...
        /*필기. Stack 메모리 구조는 선형 메모리 공간에 데이터를 저장하며
        *  후입선출(LIFO - Last In First Out) 방식의 자료구조이다.*/
        ...
        /*필기. Stack 에서 요소를 찾을 댸 search()를 이용할 수 있다.
        ...
        *  pop() : 헤당 스택의 가장 마지막에 있는 (상단) 요소 반환후 제거*/

        System.out.println("peek() : " +integerStack.peek());
        System.out.println("integerStack = " + integerStack);

        System.out.println("pop() :"+integerStack.pop() );  //조회후 삭제.
        System.out.println("integerStack =" +integerStack);
